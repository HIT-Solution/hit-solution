...
const AboutUs = () => {
  return (
    <div>
      ...
      <section className="relative lg:h-[750px] md:h-[600px] h-[550px]">
        <div className="absolute top-0 left-0 w-full h-full">
          <Image
      ...
      <div className="lg:my-32 md:my-28 my-16 md:py-10 mx-5 lg:mx-10 grid lg:grid-cols-2 content-center gap-16">
        <div>
          <Image
            src={
      ...
      <div className="bg-gradient-to-br from-black to-teal-900 py-10">
        <div className="lg:my-32 md:my-28 my-16  mx-5 lg:mx-10 grid lg:grid-cols-2 content-center gap-16">
          <div>
      ...
      <div className="lg:my-32 md:my-28 my-16 md:py-10 mx-5 lg:mx-10 grid lg:grid-cols-2 content-center gap-16">
        ...
        <div>
          ...
          <p className="text-gray-700 text-justify text-lg mt-2">
            To be a leading provider of transformative technology solutions that
            drive digital innovation across industries, enhancing efficiency,
            sustainability, and connectivity globally.
          </p>
          <h1 className="lg:text-3xl md:text-3xl text-2xl font-bold text-center mt-7">
            Our Values
          </h1>
