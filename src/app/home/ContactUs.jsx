      ...
      <BackgroundModel>
        ...
        <div className="grid md:grid-cols-2 gap-20 mx-5 mt-16 lg:mx-10">
          <div className="space-y-5">
           ...
           <span className="font-bold"> get your project moving <span className="text-teal-500">!</span></span></h1>
          ...
          <Image className="rounded-2xl" alt="" src={contacLogo} width={400} height={400} quality={100}/>
          </div>
          <div>
            <form className="p-7 bg-white shadow-2xl lg:mx-20 rounded-xl space-y-5">
              ...
              <div>
                <Button className="bg-teal-500 border-teal-500 border-2 rounded-full" type="submit" color="success">Submit</Button>
              </div>
            </form>
          </div>
        </div>
