        ...
        <ReusableBackground>
          ...
          >
            <div className="flex gap-4">
              <div className="flex flex-col justify-center ml-8 items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-green-200">
                <svg
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-orange-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-yellow-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-cyan-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
          ...
          >
            <div className="flex  gap-4 my-5">
              <div className="flex flex-col justify-center ml-8 items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-yellow-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96 p-4 mx-1 bg-violet-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="32"
                  height="32"
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96 ${item.bg} p-4 mx-1 bg-blue-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96 ${item.bg} p-4 mx-1 bg-green-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
          ...
          >
            <div className="flex gap-4">
              <div className="flex flex-col ml-8 justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-red-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
              ...
              <div className="flex flex-col justify-center items-center rounded-tl-3xl rounded-br-3xl h-24 w-96  p-4 mx-1 bg-blue-200">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  width="24"
                  height="24"
