  ...
  return (
    <div>
      <div className="bg-gradient-to-br from-black to-teal-900 my-10 py-16 pb-24">
        ...
        <div className="grid grid-cols-2 md:grid-cols-5 lg:grid-cols-7 gap-5 mx-5 md:mx-10">
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-red-200 p-1">
            <svg
            ...
            >
              <path
                d="M2.66675 11.4254C2.66675 9.83054 3.30992 8.85311 4.64092 8.11239L10.1199 5.06327C12.9909 3.46555 14.4263 2.66669 16.0001 2.66669C17.5738 2.66669 19.0093 3.46555 21.8802 5.06327L27.3593 8.11239C28.6902 8.85311 29.3334 9.83055 29.3334 11.4254C29.3334 11.8579 29.3334 12.0742 29.2862 12.2519C29.0381 13.186 28.1917 13.3334 27.3743 13.3334H4.62579C3.80844 13.3334 2.96211 13.1859 2.71397 12.2519C2.66675 12.0742 2.66675 11.8579 2.66675 11.4254Z"
                stroke="#0C0A25"
                strokeWidth="1.5"
              ></path>
              <path
                d="M15.9946 9.33331H16.0066"
                stroke="#0C0A25"
                strokeWidth="1.5"
                strokeLinecap="round"
              ...
              ></path>
              <path
                d="M5.33325 13.3333V24.6666M10.6666 13.3333V24.6666"
                stroke="#0C0A25"
                strokeWidth="1.5"
              ></path>
              <path
                d="M21.3333 13.3333V24.6666M26.6666 13.3333V24.6666"
                stroke="#0C0A25"
                strokeWidth="1.5"
              ></path>
              <path
                d="M25.3334 24.6667H6.66675C4.45761 24.6667 2.66675 26.4575 2.66675 28.6667C2.66675 29.0348 2.96523 29.3334 3.33341 29.3334H28.6667C29.0349 29.3334 29.3334 29.0348 29.3334 28.6667C29.3334 26.4575 27.5426 24.6667 25.3334 24.6667Z"
                stroke="#0C0A25"
                strokeWidth="1.5"
              ></path>
            </svg>
          ...
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-green-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
          ...
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-violet-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
            ...
            >
              <path
                d="M6.66675 12C6.66675 7.60025 6.66675 5.40035 8.03359 4.03353C9.40041 2.66669 11.6003 2.66669 16.0001 2.66669C20.3998 2.66669 22.5997 2.66669 23.9666 4.03353C25.3334 5.40035 25.3334 7.60025 25.3334 12V20C25.3334 24.3998 25.3334 26.5996 23.9666 27.9666C22.5997 29.3334 20.3998 29.3334 16.0001 29.3334C11.6003 29.3334 9.40041 29.3334 8.03359 27.9666C6.66675 26.5996 6.66675 24.3998 6.66675 20V12Z"
                stroke="#0C0A25"
                strokeWidth="1.5"
                strokeLinecap="round"
              ></path>
              <path
                d="M14.6667 25.3333H17.3334"
                stroke="#0C0A25"
                strokeWidth="1.5"
                strokeLinecap="round"
                strokeLinejoin="round"
              ></path>
              <path
                d="M12 2.66669L12.1187 3.37871C12.3758 4.92174 12.5044 5.69326 13.0336 6.16274C13.5856 6.65247 14.3681 6.66669 16 6.66669C17.6319 6.66669 18.4144 6.65247 18.9664 6.16274C19.4956 5.69326 19.6241 4.92174 19.8813 3.37871L20 2.66669"
                stroke="#0C0A25"
                strokeWidth="1.5"
                strokeLinejoin="round"
              ></path>
          ...
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-blue-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
          ...
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-orange-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
          ...
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-yellow-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
          ...
          <div className="flex flex-col justify-center items-center gap-5 rounded-tl-3xl rounded-br-3xl h-32 bg-cyan-200">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="32"
              height="32"
