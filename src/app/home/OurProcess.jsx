      ...
      <div className="bg-gradient-to-br from-black to-teal-900 py-28 my-5">
        ...
        <div className="grid lg:grid-cols-2 gap-10 mx-5 lg:mx-10">
          <div>
           ...
           <div>
           <h1 className="text-2xl text-white">Initiate a Strategy Session.</h1>
           <h1 className="text-gray-200">Engage with us in a consultative meeting to explore your business goals. We&apos;ll craft a tailored approach, define key objectives, establish timelines, and determine necessary resources.</h1>
           </div>
           </div>
          </div>
          <div>right</div>
