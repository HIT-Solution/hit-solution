  ...
  return (
    <ReusableBackground>
      ...
      opacity-30 blur-2xl animate-[gradientMove_6s_infinite_alternate]"
        ...
        <div className=" xl:px-32 lg:px-12  md:px-20 gap-2 xl:ml-16  grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
          ...
          <Link href={"/services"}>
            <div className="hex-card mx-auto  relative overflow-hidden group">
              ...
              <p className="hex-desc relative z-10 text-gray-600 group-hover:text-white transition-colors duration-[500ms]">
                ...
                Prototyping, Industrial Design, and MVP Development to bring
                your ideas to life.
              </p>
            </div>
          </Link>
          ...
          <Link href={"/services"}>
            <div className="hex-card mx-auto  relative overflow-hidden group xl:-ml-40 xl:-mt-16">
              <div className="absolute inset-0 bg-gradient-to-t from-[#0884B5] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-[500ms]"></div>
              <Image
                src={qa}
          ...
          <Link href={"/services"}>
            <div className="hex-card mx-auto xl:-ml-40 xl:-mt-16 relative overflow-hidden group">
              <div className="absolute inset-0 bg-gradient-to-t from-[#0884B5] to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-[500ms]"></div>
              <Image
                src={support}
                alt="Tech Support"
              ...
              <p className="hex-desc relative z-10 text-gray-600 group-hover:text-white transition-colors duration-[500ms]">
                We provide full-spectrum IT consultancy and support, from
                network setup and cybersecurity to system migration and data
                recovery.
              </p>
            </div>
          </Link>
          ...
          <Link href={"/services"}>
            <div className="hex-card mx-auto xl:-ml-40 xl:-mt-16  relative overflow-hidden group">
              ...
              <p className="hex-desc relative z-10 text-gray-600 group-hover:text-white transition-colors duration-[500ms]">
                ...
                VR/AR experiences, and high-quality motion graphics for
