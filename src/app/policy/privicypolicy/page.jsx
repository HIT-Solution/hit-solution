...
export default function TermsAndConditions() {
  return (
    <ReusableBackground>
      <div className="min-h-screen  text-gray-800 py-16 px-5 lg:px-32">
        <div className="container mx-auto">
          {/* Page Title */}
          <h1 className="lg:text-4xl md:text-3xl text-3xl font-bold pt-20 text-center text-teal-600 mb-10">
            <TitleFontStyle title={"Terms and Conditions"} />
          </h1>

          {/* Introduction */}
          <p className="text-lg mb-6">
            Welcome to HIT Solutions! These terms and conditions outline the
            rules and regulations for the use of our website and services. By
            accessing our platform, you agree to comply with these terms. If you
          ...
          <div className="space-y-8">
            ...
            <section>
              ...
              <p>
                ...
                Your continued use of our platform signifies your acceptance of
                the revised terms.
              </p>
            </section>
            ...
            <section>
              ...
              <p>
                HIT Solutions will not be held liable for any direct, indirect,
            ...
            <section>
              ...
              <p>
                ...
                <a
                  href="mailto:info@hitsolutions.com"
